...
export function FooterBar({ theme, columns = 100 }) {
  ...
  return h(Box, { paddingX: 2, justifyContent: "space-between" },
    h(Text, { color: theme.muted }, compact ? "Ctrl+J Chat/Trajectory · Ctrl+P палитра" : "Ctrl+J Chat/Trajectory · Ctrl+P палитра · Ctrl+M модели · Ctrl+T цвет · Ctrl+L очистить"),
