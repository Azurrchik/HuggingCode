...
export function decidePermission(mode, action) {
  ...
  if (normalized === "full") {
    return { decision: "allow", reason: "Full mode автономно разрешает операции в выбранной рабочей области до завершения текущего сеанса." };
  }
...
export const permissionModeDescriptions = {
  ...
  full: "Автономные записи, удаления и команды в выбранной рабочей области до закрытия текущего сеанса; включается только typed-подтверждением.",
};
